...
data class TInstitution(
    ...
    @field:Json(name = "verified") val verified: Boolean = false,
    @Json(name = "setting") val setting: TSetting? = null,

    @field:Json(name="enterpriseId") val enterpriseId: String? = null,
    @field:Json(name="institutionId") val institutionId: String? = null,
